...
import com.example.jdbc.adapter.EmployeeAdapter;
...
public class EmployeeController {
    ...
    public ResponseEntity<String> createEmployee(@Valid @RequestBody Employee employee, BindingResult bindingResult) {
        ...
        String result = employeeAdapter.createEmployee(employee);
        return new ResponseEntity<>(result, HttpStatus.CREATED);
    }

    @GetMapping("/{id}")
    public ResponseEntity<Employee> getEmployeeById(@PathVariable Long id) {
        Employee employee = employeeAdapter.getEmployeeById(id);
        if (employee != null) {
    ...
    public ResponseEntity<List<Employee>> getAllEmployees() {
        List<Employee> employees = employeeAdapter.getAllEmployees();
    ...
    public ResponseEntity<String> updateEmployee(@PathVariable Long id, @Valid @RequestBody Employee employee, BindingResult bindingResult) {
        ...
        String result = employeeAdapter.updateEmployee(id, employee);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<String> deleteEmployee(@PathVariable Long id) {
        String result = employeeAdapter.deleteEmployee(id);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }
